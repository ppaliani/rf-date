...
public class Date {
  ...
  public int getMonth() {
    ...
    /*
     * if (month.equals("January")) return 1; else if (month.equals("February")) return 2; else if
     * (month.equalsIgnoreCase("March")) return 3; else if (month.equalsIgnoreCase("April")) return
     * 4; else if (month.equalsIgnoreCase("May")) return 5; else if (month.equals("June")) return 6;
     * else if (month.equalsIgnoreCase("July")) return 7; else if (month.equalsIgnoreCase("August"))
     * return 8; else if (month.equalsIgnoreCase("September")) return 9; else if
  ...
  public String monthString(int monthNumber) {
     ...
     * "July"; case 8: return "August"; case 9: return "September"; case 10: return "October"; case
     * 11: return "November"; case 12: return "December"; default:
     * System.out.println("Fatal Error"); System.exit(0); return "Error"; // to keep the compiler
     * happy }
     */
  }
}
